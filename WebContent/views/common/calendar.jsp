...
<link rel="stylesheet" href="views/common/vendor/css/fullcalendar.min.css" />
			...
			<div class="col-lg-6">
				...
				<div class="input-group">
					<label class="checkbox-inline"><input class='filter'
						...
						class='filter' type="checkbox" value="카테고리2" checked>&nbsp;부서일정
					</label> <label class="checkbox-inline">&nbsp;&nbsp;&nbsp;&nbsp;<input
						class='filter' type="checkbox" value="카테고리3" checked>&nbsp;개인일정
					</label> <label class="checkbox-inline">&nbsp;&nbsp;&nbsp;&nbsp;<input
						class='filter' type="checkbox" value="카테고리4" checked>&nbsp;보고서
					</label> <label class="checkbox-inline">&nbsp;&nbsp;&nbsp;&nbsp;<input
						class='filter' type="checkbox" value="카테고리5" checked>&nbsp;근태
					</label>
				</div>
			</div>
