...
<body>
  ...
  <!--**********************************
                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="views/common/images/avatar/1.jpg" alt="">
                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="views/common/images/avatar/2.jpg" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="views/common/images/avatar/3.jpg" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="views/common/images/avatar/4.jpg" alt="">
                                                <div class="notification-content">
    ...
    <!--**********************************
        Scripts
    ***********************************-->
    <script src="views/common/plugins/common/common.min.js"></script>
    <script src="views/common/js/custom.min.js"></script>
    <script src="views/common/js/settings.js"></script>
    <script src="views/common/js/gleek.js"></script>
    <script src="views/common/js/styleSwitcher.js"></script>
